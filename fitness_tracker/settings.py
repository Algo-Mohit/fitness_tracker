...
Fitness Tracking Web Application - MVC Architecture.
"""
...
SECRET_KEY = 'django-insecure-fitness-tracker-dev-key-change-in-production'
...
# Login redirect URLs (Django Auth)
